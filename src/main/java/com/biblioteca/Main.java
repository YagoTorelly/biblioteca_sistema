...
public class Main {
    ...
    private static void menuAdmin(Scanner scanner) {
        ...
        while (rodando) {
            ...
            System.out.println("4. Configurar Regras de Empréstimo");
            ...
            switch (opcao) {
                ...
                case 4 -> configurarRegrasEmprestimo(scanner);
                case 5 -> adicionarFuncionario(scanner);
    ...
    private static void listarFuncionarios() {
        ...
        System.out.printf("%-5s %-20s %-10s %-15s %-15s %-30s%n", "ID", "Nome", "Idade", "Telefone", "CPF", "Email");
        for (Funcionario funcionario : funcionarios) {
            System.out.printf("%-5s %-20s %-10d %-15s %-15s %-30s%n",
                    funcionario.getId(), funcionario.getNome(), funcionario.getIdade(), funcionario.getTelefone(), funcionario.getCpf(), funcionario.getEmail());
        }
    }
    ...
    private static void listarClientes() {
        ...
        for (Cliente cliente : clientes) {
            System.out.printf("%-5s %-20s %-10d %-15s %-15s %-30s%n",
                    cliente.getId(), cliente.getNome(), cliente.getIdade(), cliente.getTelefone(), cliente.getCpf(), cliente.getEmail());
        }
    }
    ...
    private static void realizarEmprestimo(Scanner scanner) {
        ...
        if (emprestimo != null) {
            System.out.println("Empréstimo realizado com sucesso! Data de devolução: " + emprestimo.getDataDevolucao() + ". O id do seu empréstimo é " + emprestimo.getId());
        } else {
